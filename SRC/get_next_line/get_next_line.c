...
/*   Updated: 2022/01/11 11:22:15 by xander        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strline(char const *str)
{
	size_t	len;
...
int	emptyfile(char **line, int bytes_read, char *twin)
{
	if (bytes_read < 0)
		return (-1);
	*line = ft_strdup("");
...
char	*to_line(char **line, char *twin)
{
	char	*temp;
